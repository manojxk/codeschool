...
router.post("/send", upload.single("resume"), async (req, res) => {
  ...
  `;
    let transporter = nodemailer.createTransport({
        service: "gmail",
        auth: {
            user: "sdemanojkumar@gmail.com", // generated ethereal user
    ...
    let info = await transporter.sendMail({
        from: `"Coder Connect Email" <${email}>`, // sender address
        to: "sdemanojkumar@gmail.com", // list of receivers
...
router.post("/contact", async (req, res) => {
  ...
  `;
    ...
    // send mail with defined transport object
    let info = await transporter.sendMail({
        from: '"Coder Connect Email" <sdemanojkumar@gmail.com>', // sender address
        to: "sdemanojkumar@gmail.com        ", // list of receivers
        subject: subjectTitle, // Subject line
        text: "", // plain text body
        html: output, // html body
